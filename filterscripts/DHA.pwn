...
{
	DigiHP[playerid] = TextDrawCreate(566.000000, 67.000000, "100HP");
	...
	DigiAP[playerid] = TextDrawCreate(566.000000, 45.000000, "100AR");
...
public OnPlayerUpdate(playerid)
{
	...
	format(HealthNum, sizeof(HealthNum), "%.0fHP", Health);
	...
	{
		new ArmourNum[15];
        format(ArmourNum, 15, "%.0fAR", Armour);
